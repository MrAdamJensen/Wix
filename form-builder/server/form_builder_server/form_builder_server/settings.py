"""
Django settings for form_builder_server project.
...
TEMPLATE_DIR = os.path.join(BASE_DIR,'form_builder/templates/')
...
ALLOWED_HOSTS = ['0.0.0.0', 'localhost', '127.0.0.1', "form-builder-app-il.herokuapp.com"]
...
ROOT_URLCONF = 'form_builder_server.urls'
...
WSGI_APPLICATION = 'form_builder_server.wsgi.application'
